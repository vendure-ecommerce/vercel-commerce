    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="border-border fixed top-0 right-0 bottom-0 flex h-full w-full flex-col border-l bg-white/80 p-6 text-black backdrop-blur-xl md:w-[390px] dark:bg-black/80 dark:text-white">
                            ...
                            <div className="flex flex-row">
                              ...
                              >
                                <div className="flex flex-1 flex-col text-base">
                                  ...
                                  {item.productVariant.product.optionGroups.length > 0 ? (
